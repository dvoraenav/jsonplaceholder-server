...
async function seedDatabase() {
    try {
        ...
        for (const user of limitedUsers) {
            ...
            // 2. Fetch and insert 5 Todos for this specific user
            ...
            // 3. Fetch and insert 4 Posts for this specific user
            ...
            for (const post of limitedPosts) {
                ...
                // 4. Fetch and insert 3 Comments for this specific post
